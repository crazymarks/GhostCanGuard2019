Shader "Custom/DrawOutline4"
{
	...
	_Color("Outline Color",Color) = (0,1,0,1)		// 描边颜色
		...
		_Gradient("Gradient",float) = 1					// 渐变效果
	}
		SubShader
	{
...
#include "UnityCG.cginc"
	...
	{
		float alpha = lerp(1, (ColorIntensityInRadius / count), _Gradient) * _Color.a;	// 透明度随边缘程度变化
		return alpha * _Color + (1 - alpha) * tex2D(_SceneTex, i.uv);
	}
	}
		ENDCG
	}
